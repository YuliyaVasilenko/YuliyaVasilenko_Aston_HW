...
Для запуска всех тестов: ./mvnw test

Все микросервисы собраны в docker-compose.yml
Для запуска проекта выполнить: docker compose up -d
...
3. GET-ALL — получить всех пользователей
